...
const resume = [
  {
    ...
    bullets: [
      'Built ReactJs UI for preliminary stage software catalog and software discrepancy tracking application adding styling and functionality.',
      'Implemented ORM for aforementioned software catalog and discrepancy tracking system using Spring, Hibernate, and MyBatis.',
      'Assisted development of API endpoints using REST and GraphQL.',
      'Created SQL schemas for Oracle and H2 databases.',
