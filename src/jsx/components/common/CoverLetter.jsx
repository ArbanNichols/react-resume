...
const CoverLetter = () => {
  return (
    <div className="coverletter">
      ...
      <strong>TLDR; </strong>
      <span>
        Veteran Air Force Electrician retrained to provide you websites and web
        applications.
      </span>
      <p>
        Nice to make your acquaintance! I am a former aircraft environmental and
        electrical tehcnicain for the Air Force who used the GI Bill to gain a
        B.Sc. in Computer Science. During my undergraduate studies I performed
        research under network science study grants aimed at creating Android
